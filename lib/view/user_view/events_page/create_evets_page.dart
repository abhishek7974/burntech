...
class CreateEventsPage extends ConsumerStatefulWidget {
  ...
  final bool? isEvents;
  CreateEventsPage({this.eventType, this.isEvents});
...
class _CreateEventsPageState extends ConsumerState<CreateEventsPage> {
  ...
  Future<void> _saveEvent() async {
    ...
    final eventCont = ref.read(eventController);
      ...
      await eventCont.saveEvent(
        ...
        time: '${_selectedTime!.hourOfPeriod}:${_selectedTime!.minute} ${_selectedTime!.period.name.toUpperCase()}',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        title: Text('${(widget.eventType ?? "Event").toCapitalized } details',),
