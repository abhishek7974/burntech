...
class AddLocationPageAdmin extends ConsumerStatefulWidget {
  LatLng? latLng;

  AddLocationPageAdmin({this.latLng});

  @override
  _AddLocationPageAdminState createState() => _AddLocationPageAdminState();
}

class _AddLocationPageAdminState extends ConsumerState<AddLocationPageAdmin> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((callback) {
      ...
      homeData.loadMarkersAdmin(context);
...
showRemoveMarkerDialog(MarkerId markerId, Map<String, dynamic> data,
          ...
          return Column(
            ...
            children: [
              ...
              buildDialogOption(
                ...
                color: Colors.red,
                onTap: () {
                  homeData.removeMarkerAdmin(markerId);
                  Navigator.pop(context);
                },
              ),
            ],
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                _buildIconButton(
                  context,
                  icon: 'assets/images/hospital-building.png',
                  label: "Save",
                  color: Colors.pink,
